...
public class GameView extends View {
    ...
    public void setUser(String u) {game.setUser(u); }
    public void setPassword(String p) {game.setPassword(p); }
    ...
    public void loadInstanceState(Bundle bundle) {
        ...
        currentTurn = game.getPlayer();
    }

    public void savePipeAreaXml() throws IOException {
        game.saveXML();
    }
...
/// add saveXML() function to be called in saveToCloud as view.saveXML(name,xml);
