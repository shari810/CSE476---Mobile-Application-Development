...
import edu.msu.sharinic.cloudhatter.Cloud.Models.Hat;
import edu.msu.sharinic.cloudhatter.Cloud.Models.Item;
import edu.msu.sharinic.cloudhatter.Cloud.Models.LoadResult;
import edu.msu.sharinic.cloudhatter.Cloud.Models.SaveResult;
import edu.msu.sharinic.cloudhatter.HatterView;
import edu.msu.sharinic.cloudhatter.R;
...
public class Cloud {
    ...
    private static final String USER = "sharinic";
    ...
    public static class CatalogAdapter extends BaseAdapter {
        ...
        public String getId(int position) {
            return String.valueOf(catalog.getItems().get(position));
        }
